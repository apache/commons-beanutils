...
/**
 * {@link org.apache.commons.beanutils2.Converter} implementation that handles conversion to and from <b>java.time.ZoneId</b> objects.
 * <p>
...
public final class ZoneIdConverter extends AbstractConverter<ZoneId> {
    ...
    /**
     * Constructs a <b>java.time.ZoneId</b> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public ZoneIdConverter() {
    }

    /**
     * Constructs a <b>java.time.ZoneId</b> <em>Converter</em> that returns a default value if an error occurs.
     *
