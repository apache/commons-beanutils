...
/**
 * {@link org.apache.commons.beanutils2.Converter} implementation that handles conversion to and from <strong>java.time.MonthDay</strong> objects.
 * <p>
...
public final class MonthDayConverter extends AbstractConverter<MonthDay> {
    ...
    /**
     * Constructs a <strong>java.time.MonthDay</strong> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public MonthDayConverter() {
    }

    /**
     * Constructs a <strong>java.time.MonthDay</strong> <em>Converter</em> that returns a default value if an error occurs.
     *
