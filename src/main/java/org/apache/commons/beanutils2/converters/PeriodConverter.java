...
/**
 * {@link org.apache.commons.beanutils2.Converter} implementation that handles conversion to and from <b>java.time.Period</b> objects.
 * <p>
...
public final class PeriodConverter extends AbstractConverter<Period> {
    ...
    /**
     * Constructs a <b>java.time.Period</b> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public PeriodConverter() {
    }

    /**
     * Constructs a <b>java.time.Period</b> <em>Converter</em> that returns a default value if an error occurs.
     *
