 ...
 * {@link LocaleConvertUtilsBean}. These static utility method use the default
 * instance. More sophisticated can be provided by using a
 * {@code LocaleConvertUtilsBean} instance.
 * </p>
 */
public class LocaleConvertUtils {
    ...
    /**
     * <p>
     * Gets the {@code Locale} which will be used when no {@code Locale} is passed
     * to a method.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Sets the {@code Locale} which will be used when no {@code Locale} is passed
     * to a method.
     * </p>
     * <p>
     * For more details see {@code LocaleConvertUtilsBean}
