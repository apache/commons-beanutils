...
/**
 * {@link org.apache.commons.beanutils2.Converter} implementation that handles conversion to and from <b>java.util.UUID</b> objects.
 * <p>
...
public final class UUIDConverter extends AbstractConverter<UUID> {
    ...
    /**
     * Constructs a <b>java.util.UUID</b> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public UUIDConverter() {
    }

    /**
     * Constructs a <b>java.util.UUID</b> <em>Converter</em> that returns a default value if an error occurs.
     *
