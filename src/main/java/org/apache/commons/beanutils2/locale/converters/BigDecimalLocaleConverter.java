 ...
 * error occurs.
 */
public class BigDecimalLocaleConverter extends DecimalLocaleConverter<BigDecimal> {
    ...
    public static class Builder extends DecimalLocaleConverter.Builder<Builder, BigDecimal> {
        ...
        public BigDecimalLocaleConverter get() {
            return new BigDecimalLocaleConverter(defaultValue, locale, pattern, useDefault || defaultValue != null, localizedPattern);
        }
    ...
    private BigDecimalLocaleConverter(final BigDecimal defaultValue, final Locale locale, final String pattern, final boolean useDefault,
     ...
     */
    @Override
    protected BigDecimal parse(final Object value, final String pattern) throws ParseException {
