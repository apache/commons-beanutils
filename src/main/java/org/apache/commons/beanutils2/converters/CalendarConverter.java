...
/**
 * {@link DateTimeConverter} implementation that handles conversion to and from <strong>java.util.Calendar</strong> objects.
 * <p>
...
public final class CalendarConverter extends DateTimeConverter<Calendar> {
    ...
    /**
     * Constructs a <strong>java.util.Calendar</strong> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public CalendarConverter() {
    }

    /**
     * Constructs a <strong>java.util.Calendar</strong> <em>Converter</em> that returns a default value if an error occurs.
     *
