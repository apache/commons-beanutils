...
/**
 * <p>
 * A specialized extension to {@code DynaClass} that allows properties to be
 * added or removed dynamically.
 * </p>
 * <p>
 * <strong>WARNING</strong> - No guarantees that this will be in the final APIs
 * ... it's here primarily to preserve some concepts that were in the original
...
public interface MutableDynaClass extends DynaClass {
    ...
    /**
     * Is this DynaClass currently restricted, if so, no changes to the existing
     * registration of property names, data types, readability, or writeability are
     * allowed.
     *
