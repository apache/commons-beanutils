...
/**
 * {@link DateTimeConverter} implementation that handles conversion to and from <strong>java.time.LocalDateTime</strong> objects.
 * <p>
...
public final class LocalDateTimeConverter extends DateTimeConverter<LocalDateTime> {
    ...
    /**
     * Constructs a <strong>java.time.LocalDateTime</strong> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public LocalDateTimeConverter() {
    }

    /**
     * Constructs a <strong>java.time.LocalDateTime</strong> <em>Converter</em> that returns a default value if an error occurs.
     *
