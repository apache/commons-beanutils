 ...
 * <h3>Usage</h3>
 * <p>
 * To decorate a {@link DynaBean} simply instantiate this class with the target
 * {@link DynaBean}:
 * </p>
 * <ul>
 ...
 * </ul>
 * <p>
 * The above example creates a <b><i>read only</i></b> {@code Map}. To create a
 * {@code Map} which can be modified, construct a
 ...
 *    {@code Set</code> and it does not support the Map's <code>clear()} and
