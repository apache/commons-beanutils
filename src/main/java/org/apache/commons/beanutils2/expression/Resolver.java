 ...
 * <p>
 * Methods such as PropertyUtilsBean's {@code setNestedProperty()} method use a
 * {@code Resolver} to process a <i>property name</i> expression and resolve
 * <i>nested</i>, <i>indexed</i> and <i>mapped</i> property names. The following
 * code provides an example usage demonstrating all the methods:
 *
 * <pre>
 ...
 * BeanUtils/PropertyUtils uses the {@code resolver}. The following are the main
 * methods that use it:
 * <ul>
