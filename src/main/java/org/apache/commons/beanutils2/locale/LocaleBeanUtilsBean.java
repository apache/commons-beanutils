...
public class LocaleBeanUtilsBean extends BeanUtilsBean {
    ...
    /**
     * Contains {@code LocaleBeanUtilsBean} instances indexed by context
     * classloader.
     */
     ...
     * {@link LocaleBeanUtils}. This is a pseudo-singleton - an single instance is
     * provided per (thread) context classloader. This mechanism provides isolation
     * for web apps deployed in the same container.
     *
    ...
    /**
     * Is the pattern to be applied localized (Indicate whether the pattern is
     * localized or not)
     *
    ...
    /**
     * Sets whether the pattern is applied localized (Indicate whether the pattern
     * is localized or not)
     *
    ...
    /**
     * Return the value of the specified locale-sensitive indexed property of the
     * specified bean, as a String. The zero-relative index of the required value
     * must be included (in square brackets) as a suffix to the property name, or
    ...
    /**
     * Return the value of the specified locale-sensitive indexed property of the
     * specified bean, as a String using the default conversion pattern of the
     * corresponding {@link LocaleConverter}. The zero-relative index of the
     * required value must be included (in square brackets) as a suffix to the
     * property name, or {@code IllegalArgumentException} will be thrown.
     *
     * @param bean Bean whose property is to be extracted
     * @param name {@code propertyname[index]} of the property value to be extracted
     * @return The indexed property's value, converted to a String
    ...
    /**
     * Return the value of the specified locale-sensetive indexed property of the
     * specified bean, as a String using the specified conversion pattern. The index
     * is specified as a method parameter and must *not* be included in the property
     * name expression
     *
     * @param bean Bean whose property is to be extracted
     ...
     * Return the value of the specified locale-sensetive indexed property of the
     * specified bean, as a String using the default conversion pattern of the
     * corresponding {@link LocaleConverter}. The index is specified as a method
     * parameter and must *not* be included in the property name expression
     *
     * @param bean Bean whose property is to be extracted
     * @param name Simple property name of the property value to be extracted
     * @param index Index of the property value to be extracted
    ...
    /**
     * Return the value of the specified simple locale-sensitive property of the
     * specified bean, converted to a String using the specified conversion pattern.
     *
     * @param bean Bean whose property is to be extracted
    ...
    /**
     * Return the value of the specified simple locale-sensitive property of the
     * specified bean, converted to a String using the default conversion pattern of
    ...
    /**
     * Return the value of the specified mapped locale-sensitive property of the
     * specified bean, as a String using the specified conversion pattern. The key
     * is specified as a method parameter and must *not* be included in the property
     * name expression.
     *
     * @param bean Bean whose property is to be extracted
    ...
    /**
     * Return the value of the specified mapped locale-sensitive property of the
     * specified bean, as a String The key is specified as a method parameter and
    ...
    /**
     * Return the value of the specified locale-sensitive mapped property of the
     * specified bean, as a String using the specified pattern. The String-valued
     * key of the required value must be included (in parentheses) as a suffix to
     * the property name, or {@code IllegalArgumentException} will be thrown.
     *
     * @param bean Bean whose property is to be extracted
     * @param name {@code propertyname(index)} of the property value to be extracted
     * @param pattern The conversion pattern
     ...
     * Return the value of the specified locale-sensitive mapped property of the
     * specified bean, as a String using the default conversion pattern of the
     * corresponding {@link LocaleConverter}. The String-valued key of the required
     * value must be included (in parentheses) as a suffix to the property name, or
     * {@code IllegalArgumentException} will be thrown.
     *
     * @param bean Bean whose property is to be extracted
     * @param name {@code propertyname(index)} of the property value to be extracted
    ...
    /**
     * Return the value of the (possibly nested) locale-sensitive property of the
     * specified name, for the specified bean, as a String using the specified
     * pattern.
     *
     * @param bean Bean whose property is to be extracted
    ...
    /**
     * Return the value of the (possibly nested) locale-sensitive property of the
     * specified name, for the specified bean, as a String using the default
    ...
    /**
     * Return the value of the specified locale-sensitive property of the specified
     * bean, no matter which property reference format is used, as a String using
     * the specified conversion pattern.
     *
     * @param bean Bean whose property is to be extracted
     ...
     * Return the value of the specified locale-sensitive property of the specified
     * bean, no matter which property reference format is used, as a String using
     * the default conversion pattern of the corresponding {@link LocaleConverter}.
     *
     * @param bean Bean whose property is to be extracted
     * @param name Possibly indexed and/or nested name of the property to be
     *            extracted
     ...
     * Set the specified locale-sensitive property value, performing type
     * conversions as required to conform to the type of the destination property
     * using the specified conversion pattern.
     *
     * @param bean Bean on which setting is to be performed
     * @param name Property name (can be nested/indexed/mapped/combo)
     * @param value Value to be set
    ...
    /**
     * Convert the specified value to the required type using the specified
     * conversion pattern.
     *
