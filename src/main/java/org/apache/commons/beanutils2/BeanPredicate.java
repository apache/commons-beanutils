...
public class BeanPredicate<T> implements Predicate<T> {
    ...
    /**
     * Gets the {@code Predicate} to be applied to the value of the named property during {@link #test(Object)}.
     *
    ...
    /**
     * Sets the {@code Predicate} to be applied to the value of the named property during {@link #test(Object)}.
     *
