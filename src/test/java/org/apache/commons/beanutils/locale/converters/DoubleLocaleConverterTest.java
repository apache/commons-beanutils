...
public class DoubleLocaleConverterTest extends BaseLocaleConverterTest {
    ...
    public void testConstructorMain() {
        converter = new DoubleLocaleConverter(defaultValue, localizedLocale, localizedDecimalPattern, true);
        ...
        converter = new DoubleLocaleConverter(defaultValue, localizedLocale, defaultDecimalPattern, false);
