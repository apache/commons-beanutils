...
/**
 * {@link DateTimeConverter} implementation that handles conversion to and from <b>java.util.Calendar</b> objects.
 * <p>
...
public final class CalendarConverter extends DateTimeConverter<Calendar> {
    ...
    /**
     * Constructs a <b>java.util.Calendar</b> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public CalendarConverter() {
    }

    /**
     * Constructs a <b>java.util.Calendar</b> <em>Converter</em> that returns a default value if an error occurs.
     *
