...
/**
 * {@link org.apache.commons.beanutils2.Converter} implementation that handles conversion to and from <strong>java.time.ZoneId</strong> objects.
 * <p>
...
public final class ZoneIdConverter extends AbstractConverter<ZoneId> {
    ...
    /**
     * Constructs a <strong>java.time.ZoneId</strong> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public ZoneIdConverter() {
    }

    /**
     * Constructs a <strong>java.time.ZoneId</strong> <em>Converter</em> that returns a default value if an error occurs.
     *
