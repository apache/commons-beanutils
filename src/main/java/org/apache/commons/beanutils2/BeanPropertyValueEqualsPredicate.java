 ...
 * {@code true} if equal; {@code false} otherwise. The
 * {@code BeanPropertyValueEqualsPredicate} constructor takes two parameters
 * which determine what property will be evaluated on the target object and what
 ...
 * </strong></dt>
 * <dd>Will create a {@code Predicate} that will evaluate the target object and
 * return
 ...
 * </pre>
 * <p>
 * This would search a {@code Collection} of person objects and return the first
 * object whose {@code personId</code> property value equals <code>456-12-1234}.
 * Assuming...
 * </p>
 * <ul>
 * <li>The top level object in the {@code peeopleCollection} is an object which
 * represents a person.</li>
 * <li>The person object has a {@code getPersonId()} method which returns the
 * value for the object's {@code personId} property.</li>
 * </ul>
 *
...
public class BeanPropertyValueEqualsPredicate<T, V> implements Predicate<T> {
    ...
    /**
     * The name of the property which will be evaluated when this {@code Predicate}
     * is executed.
     */
    private String propertyName;

    /**
     * The value that the property specified by {@code propertyName} will be
     * compared to when this {@code Predicate} executes.
     */
     ...
     * {@code IllegalArgumentException</code> throw by <code>PropertyUtils} will be
    ...
    /**
     * Constructor which takes the name of the property, its expected value to be
     * used in evaluation, and assumes {@code ignoreNull</code> to be <code>false}.
     *
     * @param propertyName The name of the property that will be evaluated against
     *            the expected value.
     * @param propertyValue The value to use in object evaluation.
     * @throws IllegalArgumentException If the property name provided is null or
     *             empty.
     */
    ...
    /**
     * Constructor which takes the name of the property, its expected value to be
     * used in evaluation, and a boolean which determines whether {@code null}
     * objects in the property path will generate an
     * {@code IllegalArgumentException} or not.
     *
     * @param propertyName The name of the property that will be evaluated against
     *            the expected value.
     * @param propertyValue The value to use in object evaluation.
     * @param ignoreNull Determines whether {@code null} objects in the property
     *            path will generate an {@code IllegalArgumentException} or not.
     * @throws IllegalArgumentException If the property name provided is null or
     *             empty.
     */
    public BeanPropertyValueEqualsPredicate(final String propertyName, final V propertyValue,
     ...
     * {@code BeanPropertyValueEqualsPredicate} was constructed. Equality is based
     * on either reference or logical equality as defined by the property object's
     * equals method. If any object in the property path leading up to the target
     * property is {@code null} then the outcome will be based on the value of the
     * {@code ignoreNull} attribute. By default,
    ...
    /**
     * Utility method which evaluates whether the actual property value equals the
     ...
     *
     * @return The name of the property which will be evaluated when this
     *         {@code Predicate} is executed.
     */
    ...
    /**
     * Returns the value that the property specified by {@code propertyName} will be
     * compared to when this {@code Predicate} executes.
     *
     * @return The value that the property specified by {@code propertyName} will be
     *         compared to when this {@code Predicate} executes.
     */
    ...
    /**
     * Returns the flag which determines whether {@code null} objects in the
     * property path will generate an
     ...
     * logged and re-thrown.
     *
     * @return The flag which determines whether {@code null} objects in the
     *         property path will generate an {@code IllegalArgumentException} or
     *         not.
     */
