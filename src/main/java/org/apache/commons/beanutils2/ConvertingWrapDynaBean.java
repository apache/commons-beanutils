 ...
 * so that DynaBean APIs can be used to access its properties, though this
 * implementation allows type conversion to occur when properties are set. This
 * means that (say) Strings can be passed in as values in setter methods and
...
public class ConvertingWrapDynaBean extends WrapDynaBean {
    ...
    /**
     * Set the value of the property with the specified name performing any type
     * conversions if necessary. So this method can accept String values for
     * primitive numeric data types for example.
     *
     * @param name Name of the property whose value is to be set
     * @param value Value to which this property is to be set
     * @throws IllegalArgumentException if there are any problems copying the
     *             property.
     */
    @Override
    public void set(final String name, final Object value) {
        ...
        try {
            ...
            final IllegalArgumentException iae = new IllegalArgumentException("Error setting property '" + name +
                        "', exception - " + t);
