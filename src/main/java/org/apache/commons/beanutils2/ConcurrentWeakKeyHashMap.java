...
public final class ConcurrentWeakKeyHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
   ...
   */
   ...
   static final class Segment<K, V> extends ReentrantLock {
      ...
      */
      ...
      /**
       * The table is rehashed when its size exceeds this threshold. (The value of this field is always <code>(capacity
       * * loadFactor)</code>.)
       */
      int threshold;
   ...
   */
   ...
   public static interface ReusableIterator<E> extends Iterator<E> {
      void rewind();
   }
