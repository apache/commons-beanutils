 ...
 * bean property to an internal natural order {@link Comparator}, if no
 * comparator is specified in the constructor. If you are comparing two beans
 * based on a property that could contain "null" values, a suitable
 * {@code Comparator} or Apache Commons Collection {@code ComparatorChain}
 * should be supplied in the constructor. Note that the passed in
 * {@code Comparator} must be able to handle the passed in objects. Because the
 * type of the property to be compared is not known at compile time no type
 * checks can be performed by the compiler. Thus {@code ClassCastException}
 * exceptions can be thrown if unexpected property values occur.
 * </p>
 *
...
public class BeanComparator<T, V> implements Comparator<T>, Serializable {
     ...
     * </p>
     * <p>
     * <strong>Note</strong> that this is intended to be used only in bean-centric
     * environments.
     * </p>
     * <p>
     * Until {@link #setProperty} is called with a non-null value. this comparator
     * will compare the Objects only.
     * </p>
     */
    ...
    /**
     * <p>
     * Constructs a property-based comparator for beans. This compares two beans by
     * the property specified in the property parameter. This constructor creates a
     * {@code BeanComparator} that uses a {@code ComparableComparator} to compare
     * the property values.
     * </p>
     * <p>
     * Passing "null" to this constructor will cause the BeanComparator to compare
     * objects based on natural order, that is {@code java.lang.Comparable}.
     * </p>
     *
     ...
     *            {@link PropertyUtilsBean} for property query language syntax. If
     *            the property passed in is null then the actual objects will be
     *            compared
     */
    ...
    /**
     * Constructs a property-based comparator for beans. This constructor creates a
     * BeanComparator that uses the supplied Comparator to compare the property
     * values.
     *
     ...
     *            comparable or contains null values, a suitable comparator may be
     ...
     *
     * @return String method name to call to compare. A null value indicates that
     *         the actual objects will be compared
     */
    ...
    /**
     * Compare two JavaBeans by their shared property. If {@link #getProperty} is
     * null then the actual objects will be compared.
     *
    ...
    /**
     * Two {@code BeanComparator}'s are equals if and only if the wrapped
