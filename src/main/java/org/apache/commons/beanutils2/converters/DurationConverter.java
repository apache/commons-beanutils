...
/**
 * {@link org.apache.commons.beanutils2.Converter} implementation that handles conversion to and from <strong>java.time.Duration</strong> objects.
 * <p>
...
public final class DurationConverter extends AbstractConverter<Duration> {
    ...
    /**
     * Constructs a <strong>java.time.Duration</strong> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public DurationConverter() {
    }

    /**
     * Constructs a <strong>java.time.Duration</strong> <em>Converter</em> that returns a default value if an error occurs.
     *
