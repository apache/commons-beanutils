...
/**
 * {@link DateTimeConverter} implementation that handles conversion to and from <b>java.time.LocalDate</b> objects.
 * <p>
...
public final class LocalDateConverter extends DateTimeConverter<LocalDate> {
    ...
    /**
     * Constructs a <b>java.time.LocalDate</b> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public LocalDateConverter() {
    }

    /**
     * Constructs a <b>java.time.LocalDate</b> <em>Converter</em> that returns a default value if an error occurs.
     *
