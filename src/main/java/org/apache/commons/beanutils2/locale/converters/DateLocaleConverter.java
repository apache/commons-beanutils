 ...
 * {@code java.util.Date} object, optionally using a default value or throwing a
...
public class DateLocaleConverter extends BaseLocaleConverter {
     ...
     *
     * @param lenient true if the {@code DateFormat} used for formatting should be
     *            lenient
    ...
    /**
     * This method is called at class initialization time to define the value for
     * constant member DEFAULT_PATTERN_CHARS. All other methods needing this data
