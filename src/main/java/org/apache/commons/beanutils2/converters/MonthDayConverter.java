...
/**
 * {@link org.apache.commons.beanutils2.Converter} implementation that handles conversion to and from <b>java.time.MonthDay</b> objects.
 * <p>
...
public final class MonthDayConverter extends AbstractConverter<MonthDay> {
    ...
    /**
     * Constructs a <b>java.time.MonthDay</b> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public MonthDayConverter() {
    }

    /**
     * Constructs a <b>java.time.MonthDay</b> <em>Converter</em> that returns a default value if an error occurs.
     *
