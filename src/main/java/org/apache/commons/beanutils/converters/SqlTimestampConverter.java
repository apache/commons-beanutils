 ...
 * and from <strong>java.sql.Timestamp</strong> objects.
 * <p>
...
public final class SqlTimestampConverter extends DateTimeConverter {
    ...
    /**
     * Construct a <strong>java.sql.Timestamp</strong> <em>Converter</em> that throws
    ...
    /**
     * Construct a <strong>java.sql.Timestamp</strong> <em>Converter</em> that returns
