...
/**
 * <p>
 * Minimal implementation of the {@code DynaClass} interface. Can be used as a
 * convenience base class for more sophisticated implementations.
 * </p>
 * <p>
 * <strong>IMPLEMENTATION NOTE</strong> - The {@code DynaBean} implementation
 * class supplied to our constructor MUST have a one-argument constructor of its
 * own that accepts a {@code DynaClass}. This is used to associate the DynaBean
 * instance with this DynaClass.
 * </p>
 */
...
public class BasicDynaClass implements DynaClass, Serializable {
    ...
    /**
     * The constructor of the {@code dynaBeanClass} that we will use for creating
     * new instances.
     */
    protected transient Constructor<?> constructor = null;

    /**
     * The method signature of the constructor we will use to create new DynaBean
     * instances.
     */
    protected static Class<?>[] constructorTypes = {DynaClass.class};

    /**
     * The argument values to be passed to the constructor we will use to create new
     * DynaBean instances.
     */
     ...
     * {@code newInstance()} method. This Class <strong>MUST</strong> implement the
