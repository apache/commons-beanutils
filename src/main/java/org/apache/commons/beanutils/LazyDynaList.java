 ...
 *            with either {@code DynaBean}, {@code java.util.Map}
 *            or POJO Beans.</li>
 ...
 *    same type. If the {@code DynaClass} or {@code Class}
 ...
 *    using a {@code DynaClass} rather than the {@code Class}
