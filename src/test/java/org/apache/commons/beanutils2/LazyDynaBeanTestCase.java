...
public class LazyDynaBeanTestCase extends TestCase {
    ...
    public void testSimpleProperty() {
        ...
        assertEquals("Check Property type is correct", Integer.class,
    ...
    public void testMappedPropertyDefault() {
        ...
        // Set a new mapped property - should add new HashMap property and set the
        // mapped value
    ...
    public void testMappedPropertyTreeMap() {
        ...
        assertEquals("Check Property is correct type", TreeMap.class,
                    dynaClass.getDynaProperty(testProperty).getType());
        ...
        // Set a new mapped property - should instatiate a new TreeMap property and set
        // the mapped value
        bean.set(testProperty, testKey, testInteger1);
        assertEquals("Check Mapped Property exists", TreeMap.class, bean.get(testProperty).getClass());
        assertEquals("Check First Mapped Value is correct(a)", testInteger1, bean.get(testProperty, testKey));
    ...
    public void testIndexedPropertyDefault() {
        ...
        // Set the property, should create new ArrayList and set appropriate indexed
        // value
        ...
        assertEquals("Check First Array length is correct", new Integer(index + 1),
                    new Integer(((ArrayList<?>) bean.get(testProperty)).size()));

        // Set a second indexed value, should automatically grow the ArrayList and set
        ...
        assertEquals("Check Second Array length is correct", new Integer(index + 1),
                    new Integer(((ArrayList<?>) bean.get(testProperty)).size()));
    }

    /**
     * Test Getting/Setting a List 'Indexed' Property - use alternative List
     * (LinkedList)
     */
    public void testIndexedLinkedList() {
        ...
        assertEquals("Check Property is correct type", LinkedList.class,
                    dynaClass.getDynaProperty(testProperty).getType());
        assertEquals("Check Property type is correct", LinkedList.class, bean.get(testProperty).getClass());

        // Set the property, should instantiate a new LinkedList and set appropriate
        // indexed value
        bean.set(testProperty, index, testString1);
        assertEquals("Check Property type is correct", LinkedList.class, bean.get(testProperty).getClass());
        assertEquals("Check First Indexed Value is correct", testString1, bean.get(testProperty, index));
        assertEquals("Check First Array length is correct", new Integer(index + 1),
                    new Integer(((LinkedList<?>) bean.get(testProperty)).size()));

        // Set a second indexed value, should automatically grow the LinkedList and set
        // appropriate indexed value
        index = index + 2;
        bean.set(testProperty, index, testInteger1);
    ...
    public void testIndexedPrimitiveArray() {
        ...
        assertEquals("Check Indexed Property exists", primitiveArray.getClass(),
                    dynaClass.getDynaProperty(testProperty).getType());
        assertEquals("Check Indexed Property is correct type", primitiveArray.getClass(),
        ...
        assertEquals("Check First Indexed Value is correct(b)", testInteger1,
                    new Integer(((int[]) bean.get(testProperty))[index]));
        assertEquals("Check Array length is correct", new Integer(index + 1),
                    new Integer(((int[]) bean.get(testProperty)).length));

        // Set a second indexed value, should automatically grow the int[] and set
        // appropriate indexed value
        index = index + 2;
    ...
    public void testIndexedObjectArray() {
        ...
        assertEquals("Check Indexed Property exists", objectArray.getClass(),
                    dynaClass.getDynaProperty(testProperty).getType());
        assertEquals("Check Indexed Property is correct type", objectArray.getClass(),
                    bean.get(testProperty).getClass());
        ...
        assertEquals("Check First Indexed Value is correct(b)", testString1,
                    ((String[]) bean.get(testProperty))[index]);
        assertEquals("Check Array length is correct", new Integer(index + 1),
                    new Integer(((String[]) bean.get(testProperty)).length));

        // Set a second indexed value, should automatically grow the String[] and set
        // appropriate indexed value
        index = index + 2;
    ...
    public void testIndexedDynaBeanArray() {
        ...
        for (int i = index; i >= 0; i--) {
            assertEquals("Check Array Components initialized", LazyDynaMap.class,
                        bean.get(testProperty, index).getClass());
        }
        ...
        assertEquals("Check Indexed Value is correct(a)", testString2,
                    ((DynaBean) bean.get(testPropertyA, index)).get(testPropertyB));
