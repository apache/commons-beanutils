 ...
 * occurs.
 */
public class SqlDateLocaleConverter extends DateLocaleConverter<Date> {
    ...
    private SqlDateLocaleConverter(final Date defaultValue, final Locale locale, final String pattern, final boolean useDefault, final boolean locPattern,
