 ...
 *     pattern for these names, using {@code get} or {@code set} as the
 ...
 *     {@code lastName}, and {@code hireDate}, with method signatures
 *     like this:
 * <pre>
 ...
 *     {@code is} prefix instead of a {@code get} prefix if that makes
 ...
 *
 * <h2>3.2 {@code BasicDynaBean} and {@code BasicDynaClass}</h2>
 *
 ...
 * {@code BasicDynaClass}) can have the value of {@code null}.  In this
 ...
 * {@code DynaBean} instead of {@code BasicDynaBean}.  In
 ...
 *
 *
 * <h2>3.5 {@code WrapDynaBean} and {@code WrapDynaClass}</h2>
 *
 * <p>OK, you've tried the DynaBeans APIs and they are cool -- very simple
 * {@code get()} and {@code set()} methods provide easy access to all
 ...
 *              enough to accommodate the {@code index} being set then the {@code List} or
 ...
 *              {@code set(name, index, value)}) results in either a new {@code List}
 ...
 *              {@code set(name, key, value)}) results in a new {@code Map}
 ...
 *              the {@code DynaClass} as a {@code DynaBean} or regular bean and
 *              doesn't exist in the {@code DynaBean} then {@code LazyDynaBean} wiill
 ...
 *    {@code DynaBean} facade to a {@code Map} with all the usual <em>lazy</em> features. Its
 *    <em>lightweight</em> because it doesn't have an associated {@code DynaClass} containing all the properties.
 *    In fact it actually implements the {@code DynaClass} interface itself (and {@code MutableDynaClass})
 *    and derives all the <em>DynaClass</em> information from the actual contents of the {@code Map}. A
 *    {@code LazyDynaMap} can be created around an existing {@code Map} or can instantiate its own
 *    {@code Map}. After any {@code DynaBean} processing has finished the {@code Map} can be retrieved
 ...
 *      is the default {@code DynaClass} used by {@code LazyDynaBean}.
 ...
 * </pre>
 *
 * <p><em>or</em> create a {@code LazyDynaBean} and get the {@code DynaClass}...
 *
 * <pre>
 ...
 *
 * <h3>4.2 {@code BeanUtils} and {@code ConvertUtils} Conversions</h3>
 *
 ...
 * {@code int} or {@code boolean}), and property getter methods that
 ...
 * {@code BeanUtils} methods (including {@code populate()}).  To
 ...
 * <p>The standard classes in {@code org.apache.commons.beanutils} are not
 ...
 * {@code ConvertUtils} and {@code PropertyUtils}). These are easy to use but are
 ...
 * <p>
 * {@code org.apache.commons.beanutils.BeanComparator} is a {@code Comparator} implementation
 * that compares beans based on a shared property value.
 * </p>
 * <h3>6.2 Operating On Collections Of Beans</h3>
 * <p>
 * The {@code Closure} interface in {@code commons-collections} encapsulates a block of code that
 ...
 * </p>
 * <p>
 * {@code BeanPropertyValueChangeClosure} is a {@code Closure} that sets a specified property
 ...
 * <p>
 * The {@code Predicate} interface in {@code commons-collections} encapsulates an evaluation
 ...
 * </p>
 * <p>
 * {@code BeanPropertyValueEqualsPredicate} is a {@code Predicate} that evaluates a
 ...
 * <p>
 * The {@code Transformer} interface in {@code commons-collections} encapsulates the transformation
 ...
 * </p>
 * <p>
 * {@code BeanToPropertyTransformer} is a {@code Transformer} implementation
 ...
 * {@code org.apache.commons.collections.comparators.ComparableComparator}
