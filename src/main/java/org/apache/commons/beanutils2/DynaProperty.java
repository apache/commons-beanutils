 ...
 * </p>
 * <p>
 * The meta contains an <em>optional</em> content type property
 * ({@link #getContentType}) for use by mapped and iterated properties. A mapped
 * or iterated property may choose to indicate the type it expects. The DynaBean
 * implementation may choose to enforce this type on its entries. Alternatively,
 * an implementation may choose to ignore this property. All keys for maps must
 * be of type String so no meta data is needed for map keys.
 * </p>
 */
...
public class DynaProperty implements Serializable {
    ...
    /**
     * Construct an indexed or mapped {@code DynaProperty} that supports
     * (pseudo)-introspection of the content type.
     *
     * @param name Name of the property being described
     * @param type Java class representing the property data type
     ...
     * <p>
     * There are issues with serializing primitive class types on certain JVM
     * versions (including java 1.3). Therefore, this field <strong>must not be
    ...
    /**
     * Gets the <em>(optional)</em> type of the indexed content for
     * {@code DynaProperty}'s that support this feature.
     * <p>
     * There are issues with serializing primitive class types on certain JVM
     * versions (including java 1.3). Therefore, this field <strong>must not be
     * serialized using the standard methods</strong>.
     * </p>
     *
     * @return the Class for the content type if this is an indexed
     *         {@code DynaProperty} and this feature is supported. Otherwise null.
     */
     ...
     *
     * @return {@code true} if the property is indexed (i.e. is a List or array),
     ...
     * default reference test for equality provided by
     * {@link java.lang.Object#equals(Object)}
     * 
     * @param obj The object to compare to
     * @return {@code true} if object is a dyna property with the same name type and
    ...
    /**
     * Writes this object safely. There are issues with serializing primitive class
     * types on certain JVM versions (including java 1.3). This method provides a
     * workaround.
     *
    ...
    /**
     * Reads field values for this object safely. There are issues with serializing
     * primitive class types on certain JVM versions (including java 1.3). This
     * method provides a workaround.
     *
     * @param in {@link ObjectInputStream} to read object from
     * @throws StreamCorruptedException when the stream data values are outside
     *             expected range
     * @throws IOException if the input stream can't be read
     * @throws ClassNotFoundException When trying to read an object of class that is
