...
/**
 * {@link DateTimeConverter} implementation that handles conversion to and from <strong>java.time.OffsetDateTime</strong> objects.
 * <p>
...
public final class OffsetDateTimeConverter extends DateTimeConverter<OffsetDateTime> {
    ...
    /**
     * Constructs a <strong>java.time.OffsetDateTime</strong> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public OffsetDateTimeConverter() {
    }

    /**
     * Constructs a <strong>java.time.OffsetDateTime</strong> <em>Converter</em> that returns a default value if an error occurs.
     *
