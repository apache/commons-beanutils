...
/**
 * {@link DateTimeConverter} implementation that handles conversion to and from <b>java.time.LocalDateTime</b> objects.
 * <p>
...
public final class LocalDateTimeConverter extends DateTimeConverter<LocalDateTime> {
    ...
    /**
     * Constructs a <b>java.time.LocalDateTime</b> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
    public LocalDateTimeConverter() {
    }

    /**
     * Constructs a <b>java.time.LocalDateTime</b> <em>Converter</em> that returns a default value if an error occurs.
     *
