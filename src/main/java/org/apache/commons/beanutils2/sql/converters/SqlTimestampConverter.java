...
public final class SqlTimestampConverter extends DateTimeConverter<Timestamp> {
    ...
    /**
     * Constructs a <b>java.sql.Timestamp</b> <i>Converter</i> that throws a {@code ConversionException} if an error occurs.
     */
    public SqlTimestampConverter() {
    }

    /**
     * Constructs a <b>java.sql.Timestamp</b> <i>Converter</i> that returns a default value if an error occurs.
     *
