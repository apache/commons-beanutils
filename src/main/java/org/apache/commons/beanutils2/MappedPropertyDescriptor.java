 ...
 * <p>
 * where {@code <strong>Property</strong>} must be replaced by the name of the
 * property.
 * 
...
public class MappedPropertyDescriptor extends PropertyDescriptor {
     ...
     * standard Java convention by having getFoo and setFoo accessor methods, with
     * the addition of a String parameter (the key). Thus if the argument name is
     * "fred", it will assume that the writer method is "setFred" and the reader
     * method is "getFred". Note that the property name should start with a lower
    ...
    /**
     * This constructor takes the name of a mapped property, and method names for
     * reading and writing the property.
     *
     * @param propertyName The programmatic name of the property.
     * @param beanClass The Class object for the target bean. For example
     *            sun.beans.OurButton.class.
     * @param mappedGetterName The name of the method used for reading one of the
     *            property values. May be null if the property is write-only.
     * @param mappedSetterName The name of the method used for writing one of the
    ...
    /**
     * This constructor takes the name of a mapped property, and Method objects for
     * reading and writing the property.
     *
     * @param propertyName The programmatic name of the property.
     * @param mappedGetter The method used for reading one of the property values.
     *            May be be null if the property is write-only.
     * @param mappedSetter The method used for writing one the property values. May
     *            be null if the property is read-only.
     * @throws IntrospectionException if an exception occurs during introspection.
     */
     ...
     *         object may describe a built-in Java type such as "int". The result
     *         may be "null" if this is a mapped property that does not support
     *         non-keyed access.
     *         <p>
     ...
     *
     * @return The method that should be used to read the property value. May return
     *         null if the property can't be read.
     */
        ...
        try {
            ...
            if (mappedReadMethod != null) {
                ...
                if (mappedPropertyType == Void.TYPE) {
                    throw new IntrospectionException("mapped read method " +
     ...
     * method if the method reference has been released. See
