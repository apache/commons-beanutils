 ...
 * </p>
 * <p>
 * An implementation of {@code java.util.function.Consumer} that updates a
 * specified property on the object provided with a specified value. The
 * {@code BeanPropertyValueChangeClosure} constructor takes two parameters which
 * determine what property will be updated and with what value.
 * <dl>
 * <dt>
 * {@code public BeanPropertyValueChangeClosure( String propertyName, Object propertyValue )}
 * </dt>
 * <dd>Will create a {@code Closure} that will update an object by setting the
 ...
 * {@code activeEmployee</code> property of each object in the <code>Collection}
 * to {@code true}. Assuming...
 * <ul>
 * <li>The top level object in the {@code peopleCollection} is an object which
 * represents a person.</li>
 * <li>The person object has a {@code setActiveEmployee( boolean )} method which
 * updates the value for the object's {@code activeEmployee} property.</li>
 * </ul>
 *
...
public class BeanPropertyValueChangeConsumer<T, V> implements Consumer<T> {
    ...
    /**
     * The name of the property which will be updated when this {@code Closure}
     * executes.
     */
    private String propertyName;

    /**
     * The value that the property specified by {@code propertyName} will be updated
     * to when this {@code Closure} executes.
     */
    ...
    /**
     * Constructor which takes the name of the property to be changed, the new value
     * to set the property to, and assumes
     * {@code ignoreNull</code> to be <code>false}.
     *
     * @param propertyName The name of the property that will be updated with the
     *            value specified by {@code propertyValue}.
     * @param propertyValue The value that {@code propertyName} will be set to on
     *            the target object.
     * @throws IllegalArgumentException If the propertyName provided is null or
     *             empty.
     */
    ...
    /**
     * Constructor which takes the name of the property to be changed, the new value
     * to set the property to and a boolean which determines whether {@code null}
    ...
    /**
     * Updates the target object provided using the property update criteria
     * provided when this {@code BeanPropertyValueChangeClosure} was constructed. If
     * any object in the property path leading up to the target property is
     * {@code null} then the outcome will be based on the value of the
     ...
     * {@code Closure} executes.
     *
     * @return The name of the property which will be updated when this
     *         {@code Closure} executes.
     */
     ...
     * updated to when this {@code Closure} executes.
     *
    ...
    /**
     * Returns the flag that determines whether {@code null} objects in the property
     * path will generate an
     ...
     *
     * @return The flag that determines whether {@code null} objects in the property
     *         path will generate an {@code IllegalArgumentException} or not.
     */
