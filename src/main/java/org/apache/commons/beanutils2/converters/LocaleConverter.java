...
/**
 * {@link org.apache.commons.beanutils2.Converter} implementation that handles conversion to and from {@link Locale}.
 *
 * @since 2.0.0
 */
public class LocaleConverter extends AbstractConverter<Locale> {
    ...
    /**
     * Construct a <strong>{@link Locale}</strong> <em>Converter</em> that throws a {@code ConversionException} if an error occurs.
     */
