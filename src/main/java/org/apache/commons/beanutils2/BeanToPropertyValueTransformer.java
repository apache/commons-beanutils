 ...
 * </p>
 * <p>
 * An implementation of {@code java.util.function.Function} that transforms the
 * object provided by returning the value of a specified property of the object.
 * The constructor for {@code BeanToPropertyValueTransformer} requires the name
 * of the property that will be used in the transformation. The property can be
 * a simple, nested, indexed, or mapped property as defined by
 * {@code org.apache.commons.beanutils2.PropertyUtils}. If any object in the
 * property path specified by {@code propertyName</code> is <code>null} then the
 ...
 * <p>
 * This would take a
 * {@code Collection</code> of person objects and return a <code>Collection} of
 * objects which represents the cities in which each person lived. Assuming...
 * <ul>
 * <li>The top level object in the {@code peeopleCollection} is an object which
 * represents a person.</li>
 * <li>The person object has a {@code getAddress()} method which returns an
 * object which represents a person's address.</li>
 * <li>The address object has a {@code getCity()} method which returns an object
 * which represents the city in which a person lives.</li>
 * </ul>
 *
...
public class BeanToPropertyValueTransformer<T, R> implements Function<T, R> {
    ...
    /**
     * Constructs a Transformer which does not ignore nulls. Constructor which takes
     * the name of the property that will be used in the transformation and assumes
     * {@code ignoreNull</code> to be <code>false}.
     *
     * &#64;param propertyName The name of the property that will be used in the transformation.
     * @throws IllegalArgumentException If the {@code propertyName</code> is <code>null}
     * or empty.
     */
     ...
     * name of the property that will be used in the transformation and a boolean
     * which determines whether {@code null} objects in the property path will
     ...
     *             {@code propertyName</code> is <code>null} or empty.
     */
     ...
     * the object provided. If any object in the property path leading up to the
     * target property is
    ...
    /**
     * Returns the name of the property that will be used in the transformation of
     * the bean.
     *
     * @return The name of the property that will be used in the transformation of
     *         the bean.
     */
