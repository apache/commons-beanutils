 ...
 * {@code java.math.BigDecimal} object, optionally using a default value or throwing a {@link org.apache.commons.beanutils.ConversionException} if a conversion
 * error occurs.
 */
public class FloatLocaleConverter extends DecimalLocaleConverter {
    ...
    /**
     * Convert the specified locale-sensitive input object into an output object of the specified type. This method will return Float value or throw exception
     * if value cannot be stored in the Float.
     *
